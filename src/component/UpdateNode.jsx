      ...
      <div className="update">
        <div className="back">
          <span
            ...
            style={{ marginRight: 5, cursor: 'pointer',display:"flex",alignItems:"center",justifyContent:"center" }}
            onClick={mainSidebar}
          >
            <IoArrowBack style={{fontSize:"20px"}}/>
          </span>
          <h2 style={{ paddingLeft: 5, margin: 0 }}>Message</h2>
        </div>
      </div>
      <div style={{ width: `100%`, height: 2, background: '#ffff' }}></div>
